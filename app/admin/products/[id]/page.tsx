      ...
      <div className="grid gap-6 lg:grid-cols-[1fr_360px]">
        <div className="space-y-6">
            ...
            <div className="mt-4 grid grid-cols-4 gap-3 sm:grid-cols-6">
              {product.images.map((image, index) => (
                <div key={image.id} className="relative aspect-square overflow-hidden rounded-lg bg-cream-200 ring-1 ring-navy-950/10">
                  ...
                  {index === 0 ? (
                    <span className="absolute left-1 top-1 bg-navy-950 px-2 py-0.5 text-[10px] font-semibold text-cream-100">Primary</span>
                  ) : null}
                </div>
              ))}
          ...
          <section className="panel p-5">
            ...
            <div className="mt-4 divide-y divide-navy-950/10 border border-line">
