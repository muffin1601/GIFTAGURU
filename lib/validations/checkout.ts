...
import { MAX_DIRECT_PURCHASE_QUANTITY, MIN_ORDER_QUANTITY } from "@/lib/config/store";
...
export const cartItemInputSchema = z.object({
  ...
  quantity: z.number().int().min(MIN_ORDER_QUANTITY).max(MAX_DIRECT_PURCHASE_QUANTITY),
  customization: z
    .object({
