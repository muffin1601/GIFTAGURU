...
const baseProductSeoContent: ProductSeoContent[] = [
  ...
  },
  {
    ...
    cluster: "client-relationship-gifting",
    primaryKeyword: "corporate Diwali signature hamper",
    secondaryKeywords: ["Diwali employee hamper", "branded festive hamper", "corporate gift hamper", "bulk Diwali gifting", "client Diwali gifts", "Diwali hampers for companies", "customised Diwali hampers"],
    seoTitle: "Corporate Diwali Signature Hamper | Gifta Guru",
    metaDescription: "A curated corporate Diwali Signature Hamper for employee, client and partner gifting, with custom branding and bulk-order support.",
    h1: "Diwali Signature Hamper",
    shortDescription: "A polished corporate Diwali hamper for employee, client and partner gifting programmes, with a curated presentation that feels considered at every quantity.",
    detailedDescription: [
      "The Diwali Signature Hamper is a curated festive gifting option for corporate recipient lists that need a considered presentation. It gives businesses a clear, coordinated choice when selecting Diwali hampers for employees, clients, dealers or channel partners.",
      "For employee Diwali hampers, consistency matters as much as the gift itself. This signature option is designed to help a company present one thoughtful festive gesture across a team while keeping the planning conversation focused on the recipient list, branding and quantities.",
      "For client Diwali gifts, presentation and personal relevance usually carry more weight than excess. Discuss company logo placement, recipient names or a message card with the Gifta Guru team to shape a branded festive hamper around the occasion.",
      "Corporate Diwali gifting often includes more than one location or recipient group. Share the number of hampers, personalisation requirement and delivery split when requesting a bulk Diwali gifting quote so the team can recommend the right approach for your campaign.",
    ],
    keyFeatures: ["Curated corporate Diwali hamper presentation", "Suitable for employee, client and partner recipient lists", "Logo branding and personalisation options", "Message-card support for festive gifting", "Bulk Diwali gifting consultation", "Delivery-plan discussion for multi-location orders"],
    useCases: ["Employee Diwali gifting at company scale", "Client appreciation and relationship gifting", "Partner, dealer and distributor festive campaigns", "Branded Diwali hampers for business events"],
    faqs: [
      { question: "Can this hamper be branded for our company?", answer: "Yes. Share your artwork and requirement with the team to confirm the available branding options." },
      { question: "Is the Signature Hamper suitable for employee Diwali gifting?", answer: "Yes. It is designed for coordinated corporate recipient lists, including company-wide employee Diwali gifting programmes." },
      { question: "Can you help with a bulk Diwali hamper order?", answer: "Yes. Share the quantity, branding requirement and delivery locations to receive guidance for a bulk corporate Diwali gifting enquiry." },
    ],
  },
  {
    slug: "diwali-celebration-hamper",
    cluster: "client-relationship-gifting",
    primaryKeyword: "corporate Diwali celebration hamper",
    secondaryKeywords: ["festive corporate hamper", "Diwali gift set", "employee festive gifts", "bulk corporate hampers", "custom Diwali gifts", "Diwali hamper for employees", "corporate festive gift ideas"],
    seoTitle: "Corporate Diwali Celebration Hamper | Gifta Guru",
    metaDescription: "Choose a Diwali Celebration Hamper for festive corporate gifting, with bulk quantities and custom branding available on request.",
    h1: "Diwali Celebration Hamper",
    shortDescription: "A festive corporate hamper with a polished presentation for Diwali gifting programmes, helping company recipient lists feel celebratory and unified.",
    detailedDescription: [
      "The Diwali Celebration Hamper gives company-wide festive gifting a coordinated, premium-looking presentation. It is a natural fit for organisations looking for corporate festive gift ideas that can work across employees, clients and partners.",
      "A celebration hamper works especially well when every recipient should receive the same considered gesture. For employee festive gifts, a consistent presentation helps a company mark Diwali in a way that feels intentional rather than last-minute.",
      "This corporate Diwali gift set can also support client and channel-partner campaigns. The right branding approach depends on whether the gift is a broad company campaign, a relationship-focused client gesture or a named-recipient festive moment.",
      "Bulk corporate hampers need a clear brief. Tell the team the recipient quantity, desired personalisation and delivery locations, and Gifta Guru can guide the quotation around the actual Diwali gifting programme rather than a generic order.",
    ],
    keyFeatures: ["Festive corporate hamper presentation", "Designed for company-wide Diwali gifting", "Branding and personalisation options", "Useful across employee, client and partner lists", "Bulk-order guidance based on recipient quantity", "Quote support for delivery requirements"],
    useCases: ["Company-wide Diwali gifts", "Employee festive gifting programmes", "Client festive campaigns", "Dealer, distributor and channel-partner appreciation"],
    faqs: [
      { question: "Can this hamper be ordered in bulk?", answer: "Yes. Send the recipient quantity and branding requirement for a tailored bulk quotation." },
      { question: "Can we use the Celebration Hamper for employee gifts?", answer: "Yes. It is suited to coordinated employee festive-gifting programmes as well as client and partner lists." },
      { question: "Can a message card be included with a corporate Diwali hamper?", answer: "Gift-message options can be discussed with the team when you share your corporate Diwali gifting requirement." },
    ],
  },
  {
    slug: "diwali-grand-hamper",
    cluster: "luxury-executive",
    primaryKeyword: "premium corporate Diwali hamper",
    secondaryKeywords: ["luxury Diwali hamper", "executive festive gift", "premium client hamper", "leadership Diwali gifts", "branded gift hamper", "Diwali gifts for executives", "premium corporate festive gifts"],
    seoTitle: "Premium Corporate Diwali Grand Hamper | Gifta Guru",
    metaDescription: "A premium Diwali Grand Hamper for leadership, important clients and corporate festive gifting, with bespoke branding support.",
    h1: "Diwali Grand Hamper",
    shortDescription: "A premium Diwali hamper for important clients, leadership teams and special festive moments where presentation, personalisation and the relationship all matter.",
    detailedDescription: [
      "The Diwali Grand Hamper is designed for the higher-consideration end of a corporate festive gifting programme. It gives businesses a premium corporate Diwali hamper option for leadership, key clients and priority partners.",
      "For Diwali gifts for executives, the best choice is usually one that feels deliberate rather than promotional. This premium festive hamper is intended for the smaller, more considered recipient tier within a broader company Diwali gifting plan.",
      "A luxury Diwali hamper can be used for board-level contacts, senior leaders, long-standing clients or important business partners. Discuss logo application, recipient naming and message requirements with the team to make the gift appropriate for that relationship.",
      "If your campaign combines a wide employee list with a selected executive tier, the Diwali Grand Hamper can sit alongside a more volume-oriented option. Share both recipient groups in one enquiry so the team can help plan the complete corporate festive gifting programme.",
    ],
    keyFeatures: ["Premium corporate Diwali hamper presentation", "Designed for executive and leadership recipient tiers", "Suitable for priority client and partner gifting", "Branding and recipient personalisation support", "Pairs with volume gifts in a multi-tier campaign", "Bulk-order consultation for corporate festive plans"],
    useCases: ["Leadership Diwali gifts", "Priority client appreciation", "Executive festive gift programmes", "Premium partner and board-level gifting"],
    faqs: [
      { question: "Who is the Diwali Grand Hamper best suited for?", answer: "It is a strong choice for leadership teams, priority clients and other high-consideration festive recipient lists." },
      { question: "Can we combine this with a separate employee Diwali gift?", answer: "Yes. Share both recipient tiers in your enquiry and the team can discuss a coordinated corporate Diwali gifting approach." },
