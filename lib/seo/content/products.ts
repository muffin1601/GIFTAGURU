...
export const productSeoContent: ProductSeoContent[] = [
  ...
  },
  {
    ...
    secondaryKeywords: ["Diwali employee hamper", "branded festive hamper", "corporate gift hamper", "bulk Diwali gifting", "client Diwali gifts"],
    seoTitle: "Corporate Diwali Signature Hamper | Gifta Guru",
    metaDescription: "A curated Diwali Signature Hamper for employee, client and partner gifting, with corporate branding and bulk-order support.",
    h1: "Diwali Signature Hamper",
    shortDescription: "A polished corporate Diwali hamper for employee, client and partner gifting programmes.",
    detailedDescription: [
      "The Diwali Signature Hamper is a curated festive gifting option for corporate recipient lists that need a considered presentation.",
      "Use it for employee, client or partner gifting and discuss logo branding, quantities and delivery requirements with the Gifta Guru team.",
    ],
    keyFeatures: ["Curated Diwali hamper presentation", "Suitable for corporate recipient lists", "Logo branding available", "Bulk orders supported"],
    useCases: ["Employee Diwali gifting", "Client appreciation", "Partner and dealer gifting"],
    faqs: [{ question: "Can this hamper be branded for our company?", answer: "Yes. Share your artwork and requirement with the team to confirm the available branding options." }],
  },
  {
    slug: "diwali-celebration-hamper",
    cluster: "client-relationship-gifting",
    primaryKeyword: "corporate Diwali celebration hamper",
    secondaryKeywords: ["festive corporate hamper", "Diwali gift set", "employee festive gifts", "bulk corporate hampers", "custom Diwali gifts"],
    ...
    shortDescription: "A festive corporate hamper with a polished presentation for Diwali gifting programmes.",
    detailedDescription: [
      "The Diwali Celebration Hamper gives company-wide festive gifting a coordinated, premium-looking presentation.",
      "It works across employee, client and partner lists, with quantity and branding details confirmed for the selected order.",
    ],
    keyFeatures: ["Festive hamper presentation", "Corporate branding options", "Designed for employee and client lists", "Bulk orders supported"],
    useCases: ["Company-wide Diwali gifts", "Client festive campaigns", "Channel partner appreciation"],
    faqs: [{ question: "Can this hamper be ordered in bulk?", answer: "Yes. Send the recipient quantity and branding requirement for a tailored bulk quotation." }],
  },
  {
    slug: "diwali-grand-hamper",
    cluster: "luxury-executive",
    primaryKeyword: "premium corporate Diwali hamper",
    secondaryKeywords: ["luxury Diwali hamper", "executive festive gift", "premium client hamper", "leadership Diwali gifts", "branded gift hamper"],
    ...
    shortDescription: "A premium Diwali hamper for important clients, leadership teams and special festive moments.",
    detailedDescription: [
      "The Diwali Grand Hamper is designed for the higher-consideration end of a corporate festive gifting programme.",
      "Choose it for leadership, key clients and priority partners, then confirm personalisation and quantity requirements with the team.",
    ],
    keyFeatures: ["Premium festive presentation", "Suited to leadership and client gifting", "Branding and personalisation support", "Bulk order consultation"],
    useCases: ["Leadership Diwali gifts", "Priority client appreciation", "Premium partner gifting"],
    faqs: [{ question: "Who is the Diwali Grand Hamper best suited for?", answer: "It is a strong choice for leadership teams, priority clients and other high-consideration festive recipient lists." }],
  },
];
